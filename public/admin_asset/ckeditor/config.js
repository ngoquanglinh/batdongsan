...
CKEDITOR.editorConfig = function( config )
{
    ...
    config.language = 'vi';
        ...
        config.filebrowserBrowseUrl= 'http://localhost/batdongsan/public/admin_asset/ckfinder/ckfinder.html';
        config.filebrowserUploadUrl= 'http://localhost/batdongsan/public/admin_asset/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files';
