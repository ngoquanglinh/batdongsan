    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="price-title">
                <span><b>Giá:</b><strong>{{$tinrao->b_gia}}&nbsp</strong></span>
                        ...
                        <div class="tab-item" id="tab-main-info">
                            <div class="">
                                <div class="slider slider-for bgr-tab ">
                                    @foreach($tinrao->anhcanmuacanthue as $t)
                                    <img src="http://localhost:8000/assets/uploads/images/{{$t->a_ten}}" alt="">
                                    @endforeach
                                </div>
                                <div class="slider slider-nav list-tab-img">
                                    @foreach($tinrao->anhcanmuacanthue as $t)
                                    <div><img src="http://localhost:8000/assets/uploads/images/{{$t->a_ten}}" alt=""></div>
                                    @endforeach
                                </div>
                            </div>
                        </div>
            ...
            <div class="row d-flex prd-more-info">
                ...
                <div>
                    <span> Ngày đăng:</span> {{formatDateVN($tinrao->c_ngaydang)}}
                </div>
                <div>
                    <span> Ngày hết hạn:</span> {{formatDateVN($tinrao->c_ngayhethan)}}
                </div>
            </div>
            <!-- wnd-row -->
            ...
            <div class="row header-news-kinds">
                <h2>Bán căn hộ chung cư dự án Q7 Boulevard</h2>
            </div>
            <div class="row">
                <div class="product-page-list">
                    <ul>
                        ...
                        <li>
                            <div class="p-title">
                                <a href="">
                                    <h3> 360° CHUNG CƯ CAO CẤP STELLAR GARDEN CHỈ TỪ 3.3 TỶ CĂN GÓC 3 NGỦ SIÊU ĐẸP, CK 1 TỶ, HT VAY 70% LS 0%</h3>
                                </a>
                            </div>
                            <div class="p-main d-flex">
                                <div class="product-avatar-img">
