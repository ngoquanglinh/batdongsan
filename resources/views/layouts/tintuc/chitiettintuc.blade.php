    ...
    <div class="row">
        <div class="col-md-9">
            <div class="row submenu">
                ...
                <!--  -->
            <h1 class="title-news">Năm 2020, TP.HCM sẽ xây dựng lại 15 chung cư cấp D</h1>  
            <div class="date-firts">26/12/2019 11:02 <span>|</span><img src="uploads/logo/web7.png" alt=""> </div> 
            ...
            <div class="news-disception">
                <h2>Sở Xây dựng TP.HCM lên kế hoạch đến năm 2020 sẽ hoàn tất việc di dời, phá dỡ để đầu tư xây mới thay thế 15 chung cư thuộc cấp D - cấp nguy hiểm trên địa bàn.</h2>
            </div>  
            <div>

            </div> 
            <p class="author-news">
                <strong>linh ngo</strong>
            </p>
            <div class="d-flex">
                <div class="other-news"><h2>Tin nhiều người đọc</h2></div>
            ...
            <div class="d-flex">
                <div class="other-news"><h2>Tin mới nhất</h2></div>
                <div class="other-line"></div>
            </div>
            <div class="news-read-many">
                <ul>
