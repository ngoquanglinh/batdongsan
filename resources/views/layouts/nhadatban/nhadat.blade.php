...
@section('tittle','Mua nhà | Mua bán nhà | Bán nhà đất')
@section('content')
<div class="content">
    <div class="row">
        <div class="col-md-9 produt-page">
            ...
            <div class="row produt-page-header">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="active">
                        <a href="#alltinrao" role="tab" data-toggle="tab"> <span>Tất cả tin rao(240645)</span></a>
                    </li>
