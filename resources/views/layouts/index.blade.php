            ...
            <div class="row mt-2">
                        ...
                        <div class="tab-content tab-option ">
                            <div class="tab-pane active" id="nhadatban">
                                <div class="set-height-box">
                                    ...
                                    <div>
                                        <select name="" id="chooseDienTich" selected>
                ...
                <div class="col-md-8">
                                 ...
                                 ">
                                    <div class="row new-list">
                                        <div class="col-md-5 slide-news-img">
                                            <img src="assets/uploads/images/{{$tin->t_hinhanh}}" alt="Los Angeles">
                                        </div>
                                        <div class="col-md-7 slide-news">
                                            <div>
                                                <a href="{{ route('tintuc.chitiet',[ 'slug'=> $tin->t_slug])}}">{{$tin->t_tentintuc}}</a>
                                            </div>
                                            <div>
                                                <p>{{$tin->t_motangan}}</p>
                                            </div>
                    ...
                    <div class="row">
                        <div class="list-news">
                            <ul>
                                @foreach($tinSlide as $tint)
                                <li style="text-overflow: ellipsis;"><a href="{{ route('tintuc.chitiet',['slug'=> $tint->t_slug])}}">{{$tint->t_tentintuc}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="list-tinrao">
                                    <div class="w-25">
                                        <a href="can-mua-can-thue/{{$tr->c_slug}}">
                                            @foreach($tr->anhcanmuacanthue as $anh)
                                            @if($loop->first)
                                            <img src="assets/uploads/images/{{$anh->a_ten}}" alt="">
                                            @endif
                                            @endforeach
                                        </a>
                                    </div>
                                    <div class="product-infor w-75">
                                        <div class="product-title product-vip">
                                            <a href="can-mua-can-thue/{{$tr->c_slug}}">{{$tr->c_tieude}}</a>
                                        </div>
                                        <div class="product-infor-content d-flex">
                                            ...
                                            <div class="product-infor-content-mid">
                                                <div class="">: {{$tr->gia->g_ten}}</div>
                                                <div class="">: {{$tr->dientich->d_ten}}</div>
                                                <div class="address-pd">: <a href="">{{$tr->huyen->name}}</>,<a href="">{{$tr->tinh->name}}</a></div>
                                                <p>: {{$tr->c_ngaydang}}</p>
                                            </div>
                                            </d>
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="new-last-week">
                            <ul>
                                ...
                                <li><a href="tin-tuc/{{$td->t_slug}}">{{$td->t_tentintuc}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
