...
@section('tittle','Nội - Ngoại thất | Chuyên trang về Nội - Ngoại thất – bất động sản')
@section('content')
<div class="content">
  <div class="row">
       <div class="col-md-6">
            ...
            <div class="row left-news-page">
                <div class="col-md-6">
                    <div class="left-news-img">
                        <img src="uploads/images/20191011091002-de11.jpg" alt="">
                    </div>
                    <div class="left-news-title">
                        <h3><a href="">
                          6 vật liệu tái chế phổ biến và cách ứng dụng
                           </a></h3>
                    </div>
                    <div class="">
                        <p>Vật liệu tái chế mang lại hiệu quả không thua kém các vật liệu mới và còn giúp làm giảm chi phí xây dựng, góp phần bảo vệ môi trường.</p>
                    </div>
                </div>
                     ...
                     <div class="row left-news-img1">
                         <ul>
                             <li>
                                 <div class="d-flex">
                                     <div>
                                         <a href=""><img src="uploads/images/20190926114403-0706.jpg" alt=""></a>
                                     </div>
                                     <div class="left-news-link1">
                                         <a href="">
		                        Nhà khung thép dễ mở rộng không gian cho gia đình trẻ
		                    </a>
                                     </div>
                                 </div>
                             </li>
            ...
            <!-- end-row -->
             <div class="row">
                 <p><strong>Nội thất</strong>  theo chuyên mục:</p>
             </div>
             <!-- end row -->
             <div class="row">
             ...
             <div class="row">
                  <div class="borderbold">
                      <h2>
                          <a href="">tư vấn nội - ngoại thất</a>
                      </h2>
                  </div>
                  <div class="borderbottom">
                  </div>
        ...
        <!-- end-row -->
          <div class="row">
              <div class="header-box-project clear-mg">
                  <p>trang trí theo màu</p>
               </div>
               <div class="option-color">
                    <ul>
                      <li class="red"><a href="">đỏ</a></li>
                      <li class="orange"><a href="">cam</a></li>
                      <li class="yellow"><a href="">vàng</a></li>
                      <li class="blue"><a href="">xanh</a></li>
                      <li class="pink"><a href="">hồng</a></li>
                      <li class="violet"><a href="">tím</a></li>
                      <li class="white"><a href="">trắng</a></li>
                      <li class="black"><a href="">đen</a></li>
                    </ul>
               </div>
          </div>
          <!-- end-row -->
           <div class="row mt-2">
              <div class="header-box-project clear-mg">
                  <p>trang trí theo phòng</p>
               </div>
               <div class="make-room">
                    <ul>
                        <li><a href=""><img src="uploads/images/phongkhach.png" alt="">phòng khách</a></li>
                        <li><a href=""><img src="uploads/images/phongkhach.png" alt="">phòng ngủ</a></li>
                        <li><a href=""><img src="uploads/images/phongkhach.png" alt="">phòng trẻ em</a></li>
                        <li><a href=""><img src="uploads/images/phongkhach.png" alt="">phòng bếp</a></li>
                    </ul>
               </div>
          </div>
          <!-- end-row -->
           <div class="row mt-2">
              <div class="header-box-project clear-mg">
               ...
               <div class="make-room">
                    <ul>
                        <li><a href=""><img src="uploads/images/phongkhach.png" alt="">mùa xuân</a></li>
                        <li><a href=""><img src="uploads/images/phongkhach.png" alt="">mùa hạ</a></li>
                        <li><a href=""><img src="uploads/images/phongkhach.png" alt="">mùa thu</a></li>
                        <li><a href=""><img src="uploads/images/phongkhach.png" alt="">mùa đông</a></li>
                    </ul>
               </div>
          </div>
          <!-- end-row -->
